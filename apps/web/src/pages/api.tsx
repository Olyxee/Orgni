...
const navGroups = Array.from(new Set(navSections.map((s) => s.group))).map(
  (group) => ({
    group,
          ...
          <main className="min-w-0 max-w-3xl py-10 md:py-14">
            ...
            <section id="overview" className="scroll-mt-24">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                The Orgni API gives applications programmatic access to business
                context, workflows, finance intelligence, and source-backed
                evidence, so you can build business-aware software without
              ...
              <div className="border border-primary/30 bg-primary/5 rounded-sm p-4 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <p className="text-sm">
                  ...
                  <span className="text-muted-foreground">
                    This reference describes the planned Orgni API. The
                    endpoints below are not callable yet. Request access to get
                    keys and a stable spec at launch.
                  </span>
                </p>
                <Button
                  onClick={() => {
              ...
              <dl className="divide-y divide-border border-y border-border mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-1 sm:gap-6 py-3">
                  ...
                  <dd className="text-[15px] text-muted-foreground">
                    Pinned in the URL path (
                    <span className="font-mono text-[13px]">/v1</span>).
                  </dd>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-1 sm:gap-6 py-3">
                  <dt className="font-mono text-sm font-bold">Async jobs</dt>
                  <dd className="text-[15px] text-muted-foreground">
                    Extractions run in the background and notify you via
                    webhooks.
                  </dd>
                </div>
              </dl>
            ...
            >
              ...
              <p className="text-[15px] text-muted-foreground leading-7 mb-2">
                Authenticate every request with a secret API key sent as a
              ...
              <p className="text-[15px] text-muted-foreground leading-7">
                ...
                <span className="font-mono text-[13px]">X-Org-Id</span> header.
  ...
  -H "X-Org-Id: org_8f2a91"`}</CodeBlock>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  <div
                    key={item}
                    className="flex items-center gap-2 border border-border bg-card p-3 rounded-sm"
                  >
            ...
            >
              ...
              <p className="text-[15px] text-muted-foreground leading-7 mb-6">
                ...
                <span className="font-mono text-[13px]">code</span> and a
                human-readable{" "}
                  ...
                  {r.endpoints.map((e) => (
                    ...
                    >
                      ...
                      <div className="min-w-0 pt-0.5 flex-1">
                        <code className="font-mono text-[13px] block break-all">
                          {e.path}
                        </code>
