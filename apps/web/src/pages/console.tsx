  ...
  return (
    <div className="w-64 shrink-0 flex flex-col gap-6 sticky top-22 max-h-[calc(100vh-8rem)]">
        ...
        {nav.map((item) => {
          ...
          return (
            <Link
              key={item.name}
              href={item.href}
              className={`flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors ${isActive ? "bg-accent/50 text-foreground" : "text-muted-foreground hover:bg-accent/50 hover:text-foreground"}`}
            >
      ...
      <div className="mt-auto flex flex-col gap-1 border-t border-border/50 pt-4 pr-2">
        <Link
          href="/app/settings"
          className={`flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors ${location === "/app/settings" ? "bg-accent/50 text-foreground" : "text-muted-foreground hover:bg-accent/50 hover:text-foreground"}`}
        >
