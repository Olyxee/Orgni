            ...
            >
              ...
              <div className="space-y-6 flex-1 overflow-y-auto pr-2 pb-2">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-foreground/90 leading-relaxed space-y-3">
                    <p>
                      Based on the <Citation num={1} />{" "}
                      <span className="font-medium text-foreground">
                        Master Services Agreement
                      </span>
                      , we are obligated to pay Acme Corp $45,000 per quarter.
                    </p>
                    <p>
                      The most recent <Citation num={2} />{" "}
                      <span className="font-medium text-foreground">
                        Q3 Invoice
                      </span>{" "}
                      was processed yesterday. Historical <Citation num={3} />{" "}
                      <span className="font-medium text-foreground">
                        Proofs of Payment
                      </span>{" "}
                      and the latest <Citation num={5} />{" "}
                      <span className="font-medium text-foreground">
                        Account Statement
                      </span>{" "}
                      confirm previous invoices were settled in accordance with
                      our <Citation num={4} />{" "}
                      <span className="font-medium text-foreground">
                        Vendor Policy
                      </span>
              ...
              <div className="mt-6 pt-4 border-t border-border/60 flex flex-col sm:flex-row sm:items-center justify-between text-xs text-muted-foreground gap-2 shrink-0">
                <span className="flex items-center gap-1.5 font-medium">
                  <CheckCircle className="w-3.5 h-3.5 text-primary" /> Answered
                  from 5 sources
                </span>
              ...
              {sources.map((source, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[11px] font-mono text-muted-foreground/70 truncate mt-0.5">
                      REF: {source.ref}
                    </div>
                  </div>
                </motion.div>
