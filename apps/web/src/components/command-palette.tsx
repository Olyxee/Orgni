...
const ITEMS: Item[] = [
  // Pages
  {
    ...
    path: "/",
    icon: HomeIcon,
    keywords: "landing start overview hero",
  },
  {
    id: "p-docs",
    title: "Documentation",
    ...
    path: "/docs",
    icon: BookOpen,
    keywords: "docs guide help learn",
  },
  {
    id: "p-api",
    title: "API Reference",
  ...
  },
  {
    ...
    path: "/pricing",
    icon: Tag,
    keywords: "plans cost price billing",
  },
  ...
  // Docs sections
  {
    ...
    hash: "introduction",
    icon: FileText,
    keywords: "what is orgni overview",
  },
  {
    id: "d-how",
    title: "How it works",
  ...
  },
  {
    ...
    hash: "quickstart",
    icon: FileText,
    keywords: "getting started setup begin",
  },
  {
    id: "d-concepts",
    title: "Core concepts",
    ...
    hash: "core-concepts",
    icon: FileText,
    keywords: "model context entities",
  },
  {
    id: "d-outputs",
    ...
    group: "Documentation",
    path: "/docs",
    hash: "structured-outputs",
    icon: FileText,
    keywords: "json schema machine readable evidence",
  },
  {
    id: "d-usecases",
    title: "Use cases",
