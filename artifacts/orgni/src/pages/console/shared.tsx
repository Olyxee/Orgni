...
export function DefensiveDisplay({ data }: { data: Record<string, unknown> | null | undefined }) {
  if (!data) return <span className="text-muted-foreground text-xs italic">Empty</span>;
