...
const resources = [
  ...
  },
  {
    ...
    group: "Core resources",
    endpoints: [
      { method: "POST", path: "/v1/sources", label: "Submit a source for processing." },
          ...
          <main className="min-w-0 max-w-3xl py-10 md:py-14">
            ...
            <section id="introduction" className="scroll-mt-24">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                ...
                can use. This reference covers both the core concepts of the platform and the REST API to access it.
              </p>
  ...
  -H "X-Org-Id: org_8f2a91"`}</CodeBlock>
            ...
            >
              ...
              <p className="text-[15px] text-muted-foreground leading-7 mb-6">
                ...
                <span className="font-mono text-[13px] bg-muted px-1 py-0.5 rounded-sm">X-Org-Id</span> header.
  ...
  -H "X-Org-Id: org_8f2a91"`}</CodeBlock>
            ...
            >
              ...
              <p className="text-[15px] text-muted-foreground leading-7 mb-6">
                ...
                <span className="font-mono text-[13px] bg-muted px-1 py-0.5 rounded-sm">code</span> and a
                human-readable{" "}
                <span className="font-mono text-[13px] bg-muted px-1 py-0.5 rounded-sm">message</span>.
              </p>
