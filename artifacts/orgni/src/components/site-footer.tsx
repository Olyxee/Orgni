    ...
    <footer className={footerClass}>
      <div className="max-w-[1600px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-32">
          ...
          <div>
            <h3 className="font-mono text-xs uppercase tracking-widest text-foreground mb-6">Product</h3>
            <ul className="space-y-4">
              <li><Link href="/platform" className="text-muted-foreground hover:text-foreground transition-colors font-light text-sm">Platform</Link></li>
              <li><Link href="/use-cases" className="text-muted-foreground hover:text-foreground transition-colors font-light text-sm">Use Cases</Link></li>
              <li><Link href="/infrastructure" className="text-muted-foreground hover:text-foreground transition-colors font-light text-sm">Infrastructure</Link></li>
              <li><Link href="/developers" className="text-muted-foreground hover:text-foreground transition-colors font-light text-sm">Developers</Link></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-mono text-muted-foreground uppercase tracking-widest">
          ...
          <div className="flex gap-6">
            <a href="https://www.olyxee.com/privacy" className="hover:text-foreground transition-colors">Privacy Policy</a>
            <a href="https://www.olyxee.com/terms" className="hover:text-foreground transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
