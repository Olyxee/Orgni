  ...
  return (
    <section className="relative py-32 md:py-48 px-6 md:px-12 bg-foreground text-background overflow-hidden border-t border-border">
      ...
      <div className="max-w-[1200px] mx-auto text-center relative z-10 flex flex-col items-center">
        ...
        >
          <Button asChild size="lg" className="w-full sm:w-auto h-16 px-10 font-bold shadow-none rounded-md text-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors">
            <a href={LOGIN_URL}>
              Request a demonstration
            </a>
          </Button>
          <Button asChild variant="outline" size="lg" className="w-full sm:w-auto h-16 px-10 font-bold border-background/30 text-background hover:bg-background hover:text-foreground rounded-md text-lg transition-colors bg-transparent">
