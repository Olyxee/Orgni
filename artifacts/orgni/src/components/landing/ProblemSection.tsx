          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10">
              {problems.map((problem, i) => (
                ...
                >
                  <div className="text-primary font-mono text-sm font-bold mb-3">{problem.num}</div>
                  <h3 className="text-base font-bold text-foreground mb-2">{problem.title}</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed font-medium">{problem.text}</p>
                </motion.div>
              ))}
            </div>
          </div>
